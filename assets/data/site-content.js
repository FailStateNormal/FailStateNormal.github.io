    ...
    items: [
      {
        ...
        bullets: ['风格：Soul、Funk、Neo Soul、轻爵士', '代表作：《特别的人》《爱爱爱》《春风吹》《三人游》', '可写角度：温柔表达、律动审美、华语 R&B 的克制感']
      },
      {
        id: 'david-tao',
        tag: 'R&B / Pop',
        ...
        bullets: ['风格：R&B、Blues、Rock、Gospel Pop', '代表作：《爱，很简单》《普通朋友》《黑色柳丁》《沙滩》', '可写角度：华语 R&B 奠基、概念专辑、都市情绪']
      },
      {
        id: 'yellow-huang',
        tag: 'Neo Soul',
        ...
        bullets: ['风格：Neo Soul、Funk、Jazz Fusion、Electronic', '代表作：《独上 C 楼》《一天》《Beanstalk》《Paradigm》', '可写角度：舞台能量、编曲色彩、复古与现代的混合']
      },
      {
        id: 'dean-ting',
        ...
        bullets: ['风格：R&B、Soul Pop、Urban Ballad', '代表作：《神经志》《Simon》《瘦子》《如果我们当时一起会怎样》', '可写角度：旋律线、夜晚氛围、细腻情绪表达']
      }
    ]
  },
  history: {
    ...
    items: [
      {
        ...
        bullets: ['关键词：隆中对、治蜀、北伐、鞠躬尽瘁', '可写角度：理想与现实、战略与国力、忠诚形象的形成', '问题：北伐是战略必要，还是资源压力下的高风险选择？']
      },
      {
        id: 'li-shimin',
        tag: '唐 / 帝王政治',
        ...
        bullets: ['关键词：玄武门之变、贞观之治、魏徵、开明政治', '可写角度：权力来源、君臣关系、盛世治理', '问题：如何评价政治功业与夺权阴影之间的张力？']
      },
      {
        id: 'confucius',
        tag: '先秦 / 儒家',
        ...
        bullets: ['关键词：仁、礼、君子、有教无类、论语', '可写角度：个人修养、社会秩序、教育观', '问题：孔子的“礼”是保守复古，还是乱世中的秩序方案？']
      }
    ]
  },
  physics: {
  ...
  'books-films': {
    ...
    groups: [
      ...
      },
      {
        ...
        title: '影视',
        items: [
          { id: 'three-kingdoms-1994', tag: '历史剧', title: '1994《三国演义》', summary: '群像、权谋、英雄理想与历史兴亡的古典叙事，可按人物线整理刘备、曹操、诸葛亮等。', bullets: ['关键词：群像、兴亡、权谋', '可写角度：人物塑造、台词、古典叙事节奏'] },
